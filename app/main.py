...
from .routers import ping_router, auth_router, project_router, time_entry_router, git_event_router
...
app.include_router(git_event_router.router, prefix="/api/v1/git-events", tags=["git-events"])
